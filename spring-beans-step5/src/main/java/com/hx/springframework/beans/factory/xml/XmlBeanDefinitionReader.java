package com.hx.springframework.beans.factory.xml;
...
import com.hx.springframework.beans.factory.support.AbstractBeanDefinitionReader;
import com.hx.springframework.beans.factory.support.BeanDefinitionRegistry;
...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
	...
	protected void doLoadBeanDefinitions(InputStream inputStream) throws ClassNotFoundException {
		...
		// 获取根结点，不能通过doc.getChildNodes()获取，因为根结点是文档元素，不是元素结点
